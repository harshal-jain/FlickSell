...
namespace Flick_Sell.Controllers
{
    public class UserController : Controller
    {
        FlickSellDBEntities db = new FlickSellDBEntities();
        //
        // GET: /User/
        ...
        public ActionResult Ads(int ?id , int? page)
        {
            ...
            int pagesize = 9, pageindex = 1;
            pageindex = page.HasValue ? Convert.ToInt32(page) : 1;
            var list = db.tbl_product.Where(x => x.pro_fk_cat == id).OrderByDescending(x => x.prod_id).ToList();
